...
Se encarga de: índices guiados por EXPLAIN, constraints, datos personales mapeados (ley de protección de datos aplicable, p. ej. RGPD en la UE, LOPDGDD en España, Ley 25.326 en Argentina, Ley 1581 de 2012 en Colombia, LFPDPPP en México, LGPD en Brasil: finalidad, retención, minimización), plan de backup y simulacro de restauración.
